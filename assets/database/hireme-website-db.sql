...
(1, 'BatMan', '123', 'Bat', 'Man', 'batman@gmail.com', 'APPLICANT_IMG-1.jpg', 0),
...
INSERT INTO `applications` (`application_id`, `applicant_id`, `job_id`, `company_id`, `applicant_full_name`, `applicant_mobile_number`, `applicant_email`, `applicant_cv`, `applicant_cover_letter`, `applied_date`, `application_recycle_bin`) VALUES
(1, 1, 5, 4, 'Bruce Wayne', '+94774129111', 'batman@gmail.com', 'batman_cv.pdf', 'batman_cover_letter.pdf', '2022-12-17 15:16:34', 0);
...
(1, '', '', 'Unilever', 'www.unilever.com', 'unilever.career@gmail.com', 'Unilever plc is a British multinational consumer goods company with headquarters in London, England. Unilever products include food, condiments, ice cream, cleaning agents, beauty products, and personal care. Unilever is the largest producer of soap in the world and its products are available in around 190 countries.', 'unilever.png', 0),
(2, '', '', 'Mobitel (Pvt) Ltd', 'www.sltmobitel.lk', 'career@mobitel.lk', 'SLT-MOBITEL is the national telecommunications services provider in Sri Lanka and one of the country\'s largest companies with an annual turnover in excess of Rs 40 billion.', 'sltmobitel.png', 0),
...
--
ALTER TABLE `applicants`
  MODIFY `applicant_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
