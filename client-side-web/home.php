...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;900&family=Work+Sans:wght@200;300;400;500;600;700;800&display=swap" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="header" id="header">
        <div class="container">
            <a href="#" class="logo">Top Jobs</a>
            <ul class="main-nav">
                <li><a href="#Articles">Articles</a> </li>
                <li><a href="#Categories">Categories</a> </li>
                <li><a href="#Features">Features</a> </li>
                <li><a class="other" href="#">Other links</a>
                    <!-- start mega menu -->
                    <div class="mega-menu">
                        <div class="image">
                        ...
                        <ul class="links">
                            ...
                            <li>
                                <a href="#Pricing Plans"><i class="fas fa-server fa-fw"></i> Pricing Plans</a>
                            </li>
                            <li><a href="#Top Videos"><i class="far fa-play-circle fa-fw"></i> Top Videos </a></li>
                            <li><a href="#Stats"><i class="far fa-chart-bar fa-fw"></i> Stats </a></li>
                            <li><a href="#Request A Discount"><i class="far fa-percent fa-fw"></i> Request A Discount </a>
                            </li>
                        </ul>
                    </div>
                    <!-- end mega menu -->
    ...
    <div class="landing">
        <div class="container">
            <div class="text">
                <h1> Welcome to <span>Top Jobs</span></h1>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.<br> Quidem culpa velit odit ex praesentium,
                    nesciunt, perspiciatis,<br> inventore error
                    mollitia dignissimos similique.</p>
            </div>
            <div class="imags">
                <img src="./imgs/landing-image.png"><a href="" class="go-down"></a>
            </div>
        </div>
    ...
    <!-- start Categories -->
    <div class="Gallery" id="Categories">
        <h2 class="main-titel">Job Categories</h2>
        <div class="container">
            <div class="box">
                <div class="image">
                    <a href="../client-side-web/jobs.php"><img src="./imgs/gallery-01.png"></a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <a href="../client-side-web/jobs.php"><img src="./imgs/gallery-02.png"></a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <a href="../client-side-web/jobs.php"><img src="./imgs/gallery-03.jpg"></a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <a href="../client-side-web/jobs.php"><img src="./imgs/gallery-04.png"></a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <a href="../client-side-web/jobs.php"><img src="./imgs/gallery-05.jpg"></a>
                </div>
            </div>
            <div class="box">
                <div class="image">
                    <a href="../client-side-web/jobs.php"><img src="./imgs/gallery-06.png"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="Features" id="Features">
        <h2 class="main-titel">Features</h2>
        <div class="container">
    ...
    <div class="TESTIMONIALS" id="Testimonials">
        <h2 class="main-titel">TESTIMONIALS</h2>
        <div class="container">
            <div class="box">
                <img src="./imgs/avatar-01.png">
                <h3>Mohamed Farag</h3>
    ...
    <div class="Team" id="Team Members">
        <h2 class="main-titel">Team Members</h2>
        <div class="container">
            <div class="box">
                <div class="data">
                    <img src="./imgs/team-01.jpg">
                    <div class="social">
    ...
    <div class="SERVICES" id="Services">
        <h2 class="main-titel">SERVICES</h2>
        <div class="container">
            <div class="box">
    ...
    <div class="our-skills" id="Our Skills">
        <h2 class="main-titel">OUR SKILLS</h2>
        <div class="container">
            <img src="./imgs/skills.png">
            <div class="skills">
                <div class="skill">
    ...
    <!-- end OUR SKILLS -->
    <!-- start work-steps -->
    <div class="work-steps" id="How It works">
        <h2 class="main-titel">HOW IT WORKS ?</h2>
        <div class="container">
            <img src="./imgs/work-steps.png">
            <div class="info">
                <div class="box">
                    <img src="./imgs/work-steps-1.png">
                    <div class="text">
    ...
    <div class="events" id="Events">
        ...
        <h2 class="main-titel">LATEST EVENTS</h2>
        <div class="container">
            ...
            <div class="info">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et vero tenetur doloremque iusto ut adipisci
    ...
    <div class="PRICING" id="Pricing Plans">
        <div class="dots dots-up"></div>
        <div class="dots dots-down"></div>
        <h2 class="main-titel">PRICING PLANS</h2>
        <div class="container">
            <div class="box">
                <h2>Basic</h2>
                <img src="./imgs/hosting-basic.png">
                <div class="pric">
                    <span>$15</span>
                    <span>Per Month</span>
                </div>
            ...
            <div class="box activ">
                ...
                <h2>Advanced</h2>
                <img src="./imgs/hosting-advanced.png">
                <div class="pric">
                    <span>$15</span>
                    <span>Per Month</span>
                </div>
            ...
            <div class="box">
                <h2>Professional </h2>
                <img src="./imgs/hosting-professional.png">
                <div class="pric">
                    <span>$15</span>
                    <span>Per Month</span>
                </div>
    ...
    <!-- end PRICING PLANS -->
    <!-- start video -->
    <div class="video" id="Top Videos">
        <h2 class="main-titel">TOP VIDEOS</h2>
        <div class="container">
            <div class="holder">
                <div class="list">
                    <div class="name">
    ...
    <footer>
        <div class="container">
            <div class="box1">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus eveniet ex similique rerum dolorum laudantium.</p>
            </div>
            <div class="box2">
                <ul class="links">
        ...
        <p class="copyright">Made With &lt;3 By El-Hawi</p>
    </footer>
    <!-- end footer -->
</body>
